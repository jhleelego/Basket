...
public class ListAdapter extends BaseAdapter
{
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        TextView oTextTitle = (TextView) convertView.findViewById(R.id.aph_tvtitle);
        TextView oTextContent = (TextView) convertView.findViewById(R.id.aph_tvcontent);
        TextView oTextDate = (TextView) convertView.findViewById(R.id.aph_tvdate);
